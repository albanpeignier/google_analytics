...
If you want to use several accounts in the page :

    before_filter :create_user_google_analytics_account

    def create_user_google_analytics_account
      user_google_tracker_id = ...

      unless user_google_tracker_id.blank?
        request.google_analytics_account = Rubaidh::GoogleAnalytics.new(user_google_tracker_id)
      end
    end
